...
public class OnScreenNumpad extends ChangeListener {
	...
	TextureRegionDrawable[] button_small = {new TextureRegionDrawable(MapRenderer.Texture_Atlas_Objs.findRegion("button_small_unpressed")),
										 	new TextureRegionDrawable(MapRenderer.Texture_Atlas_Objs.findRegion("button_small_pressed"))};
		
		
	TextureRegionDrawable[] button_large = {new TextureRegionDrawable(MapRenderer.Texture_Atlas_Objs.findRegion("button_medium_unpressed")),
											new TextureRegionDrawable(MapRenderer.Texture_Atlas_Objs.findRegion("button_medium_pressed"))};
	...
	public OnScreenNumpad() {
		...
		for(int i2=0; i2<12; i2++) {
			if(buttons[i2] != null) {
				...
				OnScreenController.stage.addActor(buttons[i2]);
	...
	public void changed(ChangeEvent event, Actor actor) {
		...
		OnScreenController.stage.keyTyped(typed);
		}
		else {
			char typed = '\b';
			OnScreenController.stage.keyTyped(typed);
