...
public class Sprite extends TextureRegion {
	...
	static final int VERTEX_SIZE2 = 2 + 1 + 2 + 2 + 1;
	public static final int SPRITE_SIZE2 = 4 * VERTEX_SIZE2;
	...
	public void draw (CustomBatch spriteBatch) {
		spriteBatch.draw(texture, getVertices(), 0, SPRITE_SIZE);
	}

	public void draw (CustomBatch spriteBatch, float alphaModulation) {
