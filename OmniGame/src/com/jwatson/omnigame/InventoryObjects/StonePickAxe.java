...
public class StonePickAxe extends InvObject {

	
	
	
	public StonePickAxe(int id,String nme) {
		super(id);
		// TODO Auto-generated constructor stub
		name = nme;
		descName = "Stone Pickaxe";
		...
		Delay = 100;
		DefaultMine = false;
		CraftingRequirements = "MAT_Tree_Brown 3 MAT_Stone 5";
