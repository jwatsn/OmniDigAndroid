...
public class WoodAxe extends InvObject {

	
	public WoodAxe(int id,String nme) {
		super(id);
		...
		Delay = 100;
		DefaultMine = false;
		CraftingRequirements = "MAT_Tree_Brown 5";
		strongAgainst.add(InvObject.Type.WOOD);
	...
	public void OnUse(Bob bob,float x, float y, float angle) {
		...
		if(flag)
		{
			...
			parentinv.owner.Animate(new JItemAnimation(ActiveSprite),ANIMATE_STYLE_ROTATE,0.3f);
			}
		}
